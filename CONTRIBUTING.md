# Contributing to the HPC0 Documentation repository

:tada: **Welcome to the HPC0 Documentation GitHub repository!** :tada:
...
- Open an [issue](https://github.com/ARCTraining/hpc0-docs/issues)
